...
namespace BackStagePassServer.Migrations
{
    ...
    [Migration("20250714060048_WatchRoomUserPassword")]
    partial class WatchRoomUserPassword
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackStagePassServer.Models.UserSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BackStagePassServer.Models.WatchRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BackStagePassServer.Models.WatchRoomUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BackStagePassServer.Models.UserSubscription", b =>
                {
                    b.HasOne("BackStagePassServer.Models.User", "User1")
                        .WithMany("Subscriptions")
                        .HasForeignKey("User1Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BackStagePassServer.Models.User", "User2")
            ...
            modelBuilder.Entity("BackStagePassServer.Models.WatchRoomUser", b =>
                {
                    b.HasOne("BackStagePassServer.Models.WatchRoom", "WatchRoom")
                        .WithMany("Users")
